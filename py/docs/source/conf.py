...
latex_documents = [
    (master_doc, 'docria.tex', 'docria Documentation',
     'Marcus Klang', 'manual'),
]
...
man_pages = [
    (master_doc, 'docria', 'docria Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'docria', 'docria Documentation',
     author, 'docria', 'One line description of project.',
     'Miscellaneous'),
]
